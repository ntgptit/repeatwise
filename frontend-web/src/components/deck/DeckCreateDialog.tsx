...
export interface DeckCreateDialogProps {
  open: boolean
...
export const DeckCreateDialog = React.memo<DeckCreateDialogProps>(
...
DeckCreateDialog.displayName = 'DeckCreateDialog'
