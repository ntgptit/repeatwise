...
function StatusComingSoon() {
  const calculateTimeLeft = () => {
    const launchDate = Number(new Date('2023-12-31T00:00:00Z'))
    const difference = launchDate - Number(new Date())
  ...
  Object.keys(timeLeft).forEach(interval => {
    ...
    timerComponents.push(
      <Box textAlign="center" px={3} key={interval}>
  ...
  return (
    <>
      <PageHelmet title="Status - Coming Soon" />
      <MainContent>
          ...
          <Box textAlign="center" mb={3}>
            <Container maxWidth="xs">
              ...
              <Typography variant="h3" color="text.secondary" fontWeight="normal" sx={{ mb: 4 }}>
                We&rsquo;re working on implementing the last features before our launch!
              </Typography>
            </Container>
          ...
          <Container maxWidth="sm">
            <Box sx={{ textAlign: 'center', p: 4 }}>
              <FormControl variant="outlined" fullWidth>
                ...
                />
                <FormHelperText>We&rsquo;ll email you once our website is launched!</FormHelperText>
              </FormControl>
              <Divider sx={{ my: 4 }} />
