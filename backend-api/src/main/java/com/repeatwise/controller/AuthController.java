...
public class AuthController {
    ...
    @Operation(
            ...
            description = "Register a new user account with email, optional username, and password. " +
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "400",
                    description = "Bad request - Email/username already exists or validation error",
                    content = @Content(schema = @Schema(implementation = Map.class))
            ),
            @ApiResponse(
                    responseCode = "500",
    ...
    @Operation(
            summary = "Logout user",
            description = "Logout authenticated user by revoking all refresh tokens. " +
    ...
    public ResponseEntity<Map<String, Object>> refresh(
        ...
        RefreshTokenResponse refreshTokenResponse = authService.refreshAccessToken(
